...
(navi:define-page about (:path "about.html")
  (page
    ...
    (:p
      "When I'm not glued to the computer screen, I like to explore music (and in particular musical improvisation). I play guitar, bass, tenor saxophone as well as harmonica.")
    (:p
